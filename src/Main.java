...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int mayoresCinco = 0,  sumaMayoresCinco = 0, menoresCinco = 0, sumaMenoresCinco = 0, exactamenteCinco = 0;
        ...
        if (mayoresCinco == 0) {
            ...
            exactamenteCinco = sumaMayoresCinco / mayoresCinco;
        ...
        if (menoresCinco == 0) {
            ...
            exactamenteCinco = menoresCinco / sumaMenoresCinco;
            System.out.println("La media de los estudiantes menores 5 es: "+menoresCinco);
        }
        System.out.println("La cantidad de estudiantes que tiene exactamente 5 años es: "+exactamenteCinco);
    }
}